export const SAFE_MIGRATIONS = [
  ...
  `ALTER TABLE agent_runtime ADD COLUMN daily_puzzle_difficulty TEXT NOT NULL DEFAULT 'easy';`,
  `ALTER TABLE agent_runtime ADD COLUMN daily_puzzle_level INTEGER NOT NULL DEFAULT 1;`,
  `ALTER TABLE agent_runtime ADD COLUMN last_jev_decision_at INTEGER NOT NULL DEFAULT 0;`,
  `
