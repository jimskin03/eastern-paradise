...
window.getScreenCoordsForGrid = inspector.getScreenCoordsForGrid;
window.positionInspectorDialog = inspector.positionInspectorDialog;
window.initDialogDrag = inspector.initDialogDrag;
